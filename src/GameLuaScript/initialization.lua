...
require "GameLuaScript/initialization/init_functions"
...
xpcall(function()
	...
	elseif platform_type == 1 then 				-- Android
		IMG_PATH = "/mnt/sdcard/kuniudhsh_" .. CHANNEL_ID .. "/"
...
--	end
    ...
    local scene = require "GameLuaScript/initialization/init_scene"
