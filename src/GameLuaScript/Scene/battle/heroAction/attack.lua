...
function M:normal( hero , param )
	...
	local frames = display.newFramesWithImage(IMG_PATH.."image/scene/battle/heroAction/attack.png" , 5)
...
function M:skill( hero , be_hero , param )
	...
	local sprite
	local frames = display.newFramesWithImage(IMG_PATH.."image/scene/battle/heroAction/skill_attack.png" , 5)
	sprite = display.playFrames(
		hero._cx,
		hero._cy,
		frames,
